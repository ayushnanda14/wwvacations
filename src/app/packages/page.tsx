...
import { FiSearch, FiFilter, FiMapPin, FiClock, FiStar, FiUsers, FiTrendingUp } from 'react-icons/fi';
import { packagesData, Package, getUniqueDestinations, getUniqueCategories, getUniqueTypes } from '@/data/packagesData';
...
export default function PackagesPage() {
  ...
  const updateURL = (newFilters: Record<FilterType, string>, newSearchQuery: string, newSortBy: SortOption) => {
